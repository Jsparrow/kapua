...
public interface GwtDeviceAssetService extends RemoteService {
    ...
    List<GwtDeviceAsset> read(String scopeId, String deviceId, GwtDeviceAssets deviceAssets)
            throws GwtKapuaException;

    void write(GwtXSRFToken xsrfToken, String scopeIdString, String deviceIdString, GwtDeviceAsset deviceAsset)
            throws GwtKapuaException;

    List<GwtDeviceAsset> get(PagingLoadConfig pagingLoadConfig, String scopeIdString, String deviceIdString, GwtDeviceAssets deviceAssets)
            throws GwtKapuaException;
